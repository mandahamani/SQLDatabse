...
INSERT INTO employees VALUES (501559, 'Carson', 'Mosconi', 'cmoscon10@census.gov', '2015/08/29', 'M', 32973, NULL);
...
--- set to city_id NULL for now as we have not inserted the city values into the locations table yet 
INSERT INTO shops VALUES (1, 'Common Grounds', NULL);


--- Set the coffeeshop_id for the first two employees already inserted
UPDATE employees
SET coffeeshop_id = 1 
